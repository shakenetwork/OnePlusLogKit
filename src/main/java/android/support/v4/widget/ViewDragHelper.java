...
*/
    ...
    protected boolean canScroll(View v, boolean checkV, int dx, int dy, int x, int y) {
        ...
        boolean canScrollVertically = checkV ? !ViewCompat.canScrollHorizontally(v, -dx) ? ViewCompat.canScrollVertically(v, -dy) : true : false;
    ...
    L_0x01aa:
        r0 = r26;
        r1 = r20;
        r15 = r0.checkTouchSlop(r1, r6, r7);
    L_0x01b2:
