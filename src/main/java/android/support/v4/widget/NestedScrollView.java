...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent, NestedScrollingChild, ScrollingView {
    ...
    public boolean executeKeyEvent(KeyEvent event) {
        ...
        if (canScroll()) {
            ...
            if (!(nextFocused == null || nextFocused == this)) {
                z = nextFocused.requestFocus(TransportMediator.KEYCODE_MEDIA_RECORD);
            }
            return z;
        }
    }
    ...
    public boolean pageScroll(int direction) {
        boolean down = direction == TransportMediator.KEYCODE_MEDIA_RECORD;
    ...
    L_0x000c:
        r2 = 0;
        r2 = r3.isWithinDeltaOfScreen(r0, r2, r7);
    ...
    L_0x0013:
        ...
        r2 = r3.mTempRect;
        r1 = r3.computeScrollDeltaToGetChildRectOnScreen(r2);
        r3.doScrollY(r1);
    L_0x0026:
        return;
        */
