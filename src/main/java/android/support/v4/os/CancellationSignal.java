...
public final class CancellationSignal {
    ...
    public void cancel() {
        ...
        r4 = this;
        monitor-enter(r4);
        r2 = r4.mIsCanceled;	 Catch:{ all -> 0x0025 }
    ...
    L_0x0007:
        r2 = 1;
        r4.mIsCanceled = r2;	 Catch:{ all -> 0x0025 }
        r2 = 1;
        r4.mCancelInProgress = r2;	 Catch:{ all -> 0x0025 }
        r0 = r4.mOnCancelListener;	 Catch:{ all -> 0x0025 }
        r1 = r4.mCancellationSignalObj;	 Catch:{ all -> 0x0025 }
        monitor-exit(r4);
    ...
    public void setOnCancelListener(android.support.v4.os.CancellationSignal.OnCancelListener r2) {
        ...
        r0 = r1.mOnCancelListener;	 Catch:{ all -> 0x0019 }
    ...
    L_0x000a:
        ...
        r0 = r1.mIsCanceled;	 Catch:{ all -> 0x0019 }
